...
import com.tarungoyaldev.android.unitconverter.Converter.ConversionFragment;
import com.tarungoyaldev.android.unitconverter.Converter.ConverterContentHandler;
import com.tarungoyaldev.android.unitconverter.Converter.ConverterFragmentActivity;
...
public class TemperatureConverterActivity extends DrawerNavigationActivity implements ConverterFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.temperature_converter_container) != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.temperature_converter_container, conversionFragment).commit();
        }
    }
    ...
    public ConverterContentHandler getConverterContentHandler(int position, ConversionFragment fragment) {
        return new TemperatureConverterContentHandler(
                getResources().getString(R.string.temperature_converter_name));
    }
}
